<?php include ('header.php'); ?>
	<div class="barba-container page_container game4 game4b" data-namespace="game4">
		...
		<img src="img/game4b1.svg">
		<img src="img/game4b2.svg" id="reponses">
		...
		<div class="bt_bc_container  displayNone" id="bt_qcm_container"><a href="4c_Les-atouts.php" class="bt_continuez bt_qcm " id="bt_qcm"></a></div>
